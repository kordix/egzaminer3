        ...
        <div class="container" style="padding-top:5px">
            ...
            <div style="width:400px">
                ...
                <p v-if="answerTrue"><b style="color:green">DOBRZE! </b>
                                    <span style="font-size:14px">Prawidłowa odpowiedź:</span> <span v-if="settings.tryb=='DEPOL'">{{currentQuestion?.question}} </span> <span v-if="settings.tryb=='DEPOLHEAR'">{{currentQuestion?.question}} ({{currentQuestion?.answer}}) </span> </p>
                </p>
